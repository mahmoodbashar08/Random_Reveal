...
export declare type Easing = 'easeInQuad' | 'easeOutQuad' | 'linear' | 'random';
export declare type Character = string;
export declare type Characters = Array<React.ReactNode>;
export declare type RevealCharacters = Character | Characters;
